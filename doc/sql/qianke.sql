...
CREATE TABLE `book` (
  ...
  `spider_detail` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `book_category` VALUES (7,0,'恐怖悬疑',16,NULL,NULL,NULL,NULL);
...
CREATE TABLE `crawl_single_task` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='抓取单本小说任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `friend_link` VALUES (5,'迁客书院','https://novel.xxyopen.com',11,1,NULL,NULL,NULL,NULL);
...
INSERT INTO `news` VALUES (1,1,'行业','未知','阅文推“单本可选新合同”：授权分级、免费或付费自选','阅文推“单本可选新合同”：授权分级、免费或付费自选',3,'2020-04-27 15:42:21',NULL,'2020-04-27 15:42:26',NULL);
INSERT INTO `news` VALUES (2,3,'资讯','全媒派公众号','AI小说悄然流行：人类特有的创作力，已经被AI复制？','AI小说悄然流行：人类特有的创作力，已经被AI复制？',4,'2020-04-28 15:44:07',NULL,'2020-04-28 15:44:12',NULL);
...
CREATE TABLE `order_pay` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='充值订单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `spider` VALUES (1,'香书小说','https://www.ibiquge.la/','{\"catId\": {\"1\": \"1\", \"2\": \"2\", \"3\": \"3\", \"4\": \"\", \"5\": \"6\", \"6\": \"5\", \"7\": \"\"}, \"imgExp\": \"<div[\\\\s]+id=\\\"fmimg\\\"><img alt=\\\".*?\\\" src=\\\"(.*?)\\\" width=\\\"120\\\"\", \"descExp\": \"<meta property=\\\"og:description\\\" content=\\\"(.*?)\\\"/>\", \"foreUrl\": \"\", \"authorExp\": \"property=\\\"og:novel:author\\\" content=\\\"(.*?)\\\"/>\", \"detailExp\": \"<li><span class=\\\"s2\\\">《<a href=\\\"(.*?)\\\" target=\\\"_blank\\\"\", \"statusExp\": \"\", \"imgForeUrl\": \"\", \"bookListUrl\": \"https://www.ibiquge.la/fenlei/{catId}_{page}.html\", \"bookNameExp\": \" <h1>(.*?)</h1>\", \"contentclean\": \"\", \"totalPageExp\": \"<em id=\\\"pagestats\\\">\\\\d+/(\\\\d+)</em><a\", \"chapterUrlExp\": \"<dd><a href=\'(.*?)\' >.*?</a></dd>\", \"contentEndExp\": \"(<br /><br /><p><a href=\\\")\", \"chapterListExp\": \"<dd><a href=\'.*?html\' >(.*?)</a></dd>\", \"chapterUrlFore\": \"https://www.ibiquge.la\", \"contentStartExp\": \"(<div id=\\\"content\\\">)\"}',0);
INSERT INTO `spider` VALUES (3,'书客吧','https://www.shukeba.com/','{\"catId\": {\"1\": \"qihuan\", \"2\": \"xiuzhen\", \"3\": \"xiandai\", \"4\": \"junshi\", \"5\": \"weilai\", \"6\": \"wangyou\", \"7\": \"xuanyi\"}, \"imgExp\": \"<div class=\\\"cover\\\"><img src=\\\"(.*?)\\\" alt=\\\".*?\\\"></div>\", \"descExp\": \"正版小说或者图书。</p>(.*?)<p>各位书友要是觉得\", \"foreUrl\": \"https://www.shukeba.com/\", \"authorExp\": \"<span> / 作者：(.*?)</span><script>tixing\", \"detailExp\": \"<div class=\\\"book_info\\\"><h2><a href=\\\"/book/(\\\\d+).html\\\">\", \"statusExp\": \"\", \"imgForeUrl\": \"\", \"bookListUrl\": \"https://www.shukeba.com/{catId}/{page}.html\", \"bookNameExp\": \"<div class=\\\"article\\\"><h1>(.*?)</h1>\", \"contentclean\": \"auzw.com\", \"totalPageExp\": \"<a href=\\\"/.*?/(\\\\d+).html\\\" target=\\\"_self\\\">\", \"chapterUrlExp\": \"<dd><a href=\\\"(/\\\\d+/\\\\d+.shtml)\\\">.*?</a></dd>\", \"contentEndExp\": \"(<div class=\\\"con_show_r\\\"><script>)\", \"chapterListExp\": \"<dd><a href=\\\"/\\\\d+/\\\\d+.shtml\\\">(.*?)</a></dd>\", \"chapterUrlFore\": \"https://www.shukeba.com/\", \"contentStartExp\": \"(<script>show(pc_rd);</script></div>)\"}',0);
...
CREATE TABLE `sys_log` (
  ...
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1432 DEFAULT CHARSET=utf8mb3 COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_log` VALUES (1412,-1,'获取用户信息为空','登录',181,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'127.0.0.1','2022-10-11 16:02:28');
INSERT INTO `sys_log` VALUES (1413,-1,'获取用户信息为空','登录',10,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'127.0.0.1','2022-10-11 16:02:38');
INSERT INTO `sys_log` VALUES (1414,-1,'获取用户信息为空','登录',10,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'127.0.0.1','2022-10-11 16:03:49');
INSERT INTO `sys_log` VALUES (1415,-1,'获取用户信息为空','登录',153,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'127.0.0.1','2022-10-11 16:05:55');
INSERT INTO `sys_log` VALUES (1416,-1,'获取用户信息为空','登录',150,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'192.168.113.1','2022-10-11 18:13:57');
INSERT INTO `sys_log` VALUES (1417,-1,'获取用户信息为空','登录',10,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'192.168.113.1','2022-10-11 18:15:37');
INSERT INTO `sys_log` VALUES (1418,-1,'获取用户信息为空','登录',8,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'192.168.113.1','2022-10-11 18:15:41');
INSERT INTO `sys_log` VALUES (1419,1,'admin','登录',26,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'192.168.113.1','2022-10-11 18:16:27');
INSERT INTO `sys_log` VALUES (1420,1,'admin','请求访问主页',50,'com.java2nb.system.controller.LoginController.index()',NULL,'192.168.113.1','2022-10-11 18:16:27');
INSERT INTO `sys_log` VALUES (1421,1,'admin','请求访问主页',16,'com.java2nb.system.controller.LoginController.index()',NULL,'192.168.113.1','2022-10-11 18:16:57');
INSERT INTO `sys_log` VALUES (1422,1,'admin','请求访问主页',12,'com.java2nb.system.controller.LoginController.index()',NULL,'192.168.113.1','2022-10-11 18:17:58');
INSERT INTO `sys_log` VALUES (1423,1,'admin','请求访问主页',13,'com.java2nb.system.controller.LoginController.index()',NULL,'192.168.113.1','2022-10-11 18:19:07');
INSERT INTO `sys_log` VALUES (1424,1,'admin','登录',157,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'127.0.0.1','2022-10-11 19:24:10');
INSERT INTO `sys_log` VALUES (1425,1,'admin','请求访问主页',46,'com.java2nb.system.controller.LoginController.index()',NULL,'127.0.0.1','2022-10-11 19:24:10');
INSERT INTO `sys_log` VALUES (1426,1,'admin','登录',184,'com.java2nb.system.controller.LoginController.ajaxLogin()',NULL,'127.0.0.1','2022-10-14 15:47:37');
INSERT INTO `sys_log` VALUES (1427,1,'admin','请求访问主页',59,'com.java2nb.system.controller.LoginController.index()',NULL,'127.0.0.1','2022-10-14 15:47:37');
INSERT INTO `sys_log` VALUES (1428,1,'admin','请求访问主页',17,'com.java2nb.system.controller.LoginController.index()',NULL,'127.0.0.1','2022-10-14 15:50:13');
INSERT INTO `sys_log` VALUES (1429,1,'admin','请求更改用户密码',4,'com.java2nb.system.controller.SysUserController.resetPwd()',NULL,'127.0.0.1','2022-10-14 15:57:37');
INSERT INTO `sys_log` VALUES (1430,1,'admin','编辑用户',19,'com.java2nb.system.controller.SysUserController.edit()',NULL,'127.0.0.1','2022-10-14 15:57:41');
INSERT INTO `sys_log` VALUES (1431,1,'admin','请求更改用户密码',2,'com.java2nb.system.controller.SysUserController.resetPwd()',NULL,'127.0.0.1','2022-10-14 15:57:51');
...
INSERT INTO `sys_menu` VALUES (234,0,'新闻管理','','',0,'fa fa-newspaper-o',8,NULL,NULL);
INSERT INTO `sys_menu` VALUES (235,234,'类别管理','novel/category','novel:category:category',1,'fa',6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (236,235,'查看',NULL,'novel:category:detail',2,NULL,6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (237,235,'新增',NULL,'novel:category:add',2,NULL,6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (238,235,'修改',NULL,'novel:category:edit',2,NULL,6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (239,235,'删除',NULL,'novel:category:remove',2,NULL,6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (240,235,'批量删除',NULL,'novel:category:batchRemove',2,NULL,6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (241,234,'新闻列表','novel/news','novel:news:news',1,'fa',8,NULL,NULL);
INSERT INTO `sys_menu` VALUES (242,241,'查看',NULL,'novel:news:detail',2,NULL,6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (243,241,'新增',NULL,'novel:news:add',2,NULL,6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (244,241,'修改',NULL,'novel:news:edit',2,NULL,6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (245,241,'删除',NULL,'novel:news:remove',2,NULL,6,NULL,NULL);
INSERT INTO `sys_menu` VALUES (246,241,'批量删除',NULL,'novel:news:batchRemove',2,NULL,6,NULL,NULL);
...
INSERT INTO `sys_role_menu` VALUES (4888,1,234);
INSERT INTO `sys_role_menu` VALUES (4889,1,246);
INSERT INTO `sys_role_menu` VALUES (4890,1,245);
INSERT INTO `sys_role_menu` VALUES (4891,1,244);
INSERT INTO `sys_role_menu` VALUES (4892,1,243);
INSERT INTO `sys_role_menu` VALUES (4893,1,242);
INSERT INTO `sys_role_menu` VALUES (4894,1,240);
INSERT INTO `sys_role_menu` VALUES (4895,1,239);
INSERT INTO `sys_role_menu` VALUES (4896,1,238);
INSERT INTO `sys_role_menu` VALUES (4897,1,237);
INSERT INTO `sys_role_menu` VALUES (4898,1,236);
INSERT INTO `sys_role_menu` VALUES (4899,1,241);
INSERT INTO `sys_role_menu` VALUES (4900,1,235);
...
) ENGINE=InnoDB AUTO_INCREMENT=1580828807487610881 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1579758893028892672,'15501259056','200820e3227815ed1756a6b531e7e0d2','15501259056',NULL,NULL,0,0,'2022-10-11 17:00:45','2022-10-11 17:00:45');
INSERT INTO `user` VALUES (1579796583640207360,'15501259057','e10adc3949ba59abbe56e057f20f883e','15501259057',NULL,NULL,0,0,'2022-10-11 19:30:31','2022-10-11 19:30:31');
INSERT INTO `user` VALUES (1580828807487610880,'15501259058','96e79218965eb72c92a549dd5a330112','15501259058',NULL,NULL,0,0,'2022-10-14 15:52:13','2022-10-14 15:52:13');
...
INSERT INTO `user_buy_record` VALUES (3,1579796583640207360,3,'我的小说',1580828453157003264,'第一张',0,'2022-10-14 15:51:06');
...
CREATE TABLE `user_read_history` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key_uq_userid_bookid` (`user_id`,`book_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=182 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户阅读记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_read_history` VALUES (120,1579758893028892672,1579760683678035968,1579760688287576064,'2022-10-11 17:47:54','2022-10-11 17:47:54');
INSERT INTO `user_read_history` VALUES (122,1579758893028892672,1579760655014162432,1579760661175595008,'2022-10-11 18:05:57','2022-10-11 18:05:57');
INSERT INTO `user_read_history` VALUES (123,1579796583640207360,1579760655236460544,1579760661435641856,'2022-10-12 12:07:21','2022-10-12 12:07:21');
INSERT INTO `user_read_history` VALUES (126,1579796583640207360,1579760655014162432,1579760661175595008,'2022-10-12 13:53:41','2022-10-12 13:53:41');
INSERT INTO `user_read_history` VALUES (132,1579796583640207360,1579760655236460545,1579760662953979905,'2022-10-12 13:56:06','2022-10-12 13:56:06');
INSERT INTO `user_read_history` VALUES (160,1579796583640207360,1580084940618387456,1580084946725294080,'2022-10-12 15:03:10','2022-10-12 15:03:10');
INSERT INTO `user_read_history` VALUES (163,1579796583640207360,1580092307309383680,1580092313537925120,'2022-10-12 15:36:35','2022-10-12 15:36:35');
INSERT INTO `user_read_history` VALUES (178,1579796583640207360,1580100302437142528,1580100322154565632,'2022-10-12 17:13:59','2022-10-12 17:13:59');
INSERT INTO `user_read_history` VALUES (181,1579796583640207360,3,1580828453157003264,'2022-10-14 15:51:12','2022-10-14 15:51:12');
...
-- Dump completed on 2022-10-17 17:35:37
